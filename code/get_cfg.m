...
cfg.prep.reref_chan = 38; % used in script 01, first re-referencing; 48=channel CZ. 31=Pz. []=average ref
...
% categories.
cfg.icareject.iclabel_min_acc = 0.9;% 0.75;%was: 0.75; %50% is not chance, but seems realistic based on inspection
